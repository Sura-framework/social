<div class="doc_block" style="margin-left:0px;margin-right:0px" id="doc_block{did}">
 <a href="/index.php?go=doc&act=download&did={did}"><div class="doc_format_bg cursor_pointer"><img src="/images/darr.gif" style="margin-right:5px" />{format}</div></a>
 <div id="data_doc{did}"><a href="/index.php?go=doc&act=download&did={did}"><div class="doc_name cursor_pointer" id="edit_doc_name{did}" style="max-width:580px">{name}</div></a><img class="fl_l cursor_pointer" style="margin-top:5px;margin-left:5px" src="/images/close_a.png" onClick="Doc.Del('{did}')" onMouseOver="myhtml.title({did}, 'Удалить документ', 'wall_doc_')" id="wall_doc_{did}" /></div>
