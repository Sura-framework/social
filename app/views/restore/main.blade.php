            ...
            <div class="card rounded-lg shadow-sm mt-5">
                ...
                <div id="step1">
                    <div class="card-block px-lg-7 px-4 pb-6">
                        <p class="lead text-muted mb-4 mr-3">
                            Введите адрес электронной почты, который вы использовали для регистрации, чтобы восстановить пароль, или свяжитесь
                            <a href="#">с нами,</a> если вам нужна помощь
                        </p>
                        <div class="mb-3">
                            <div class="input-group mb-5">
                                ...
                                <button class="btn btn-primary" type="button" onClick="restore.next(); return false" id="send">Отправить информацию</button>
                            </div>
                ...
                <div class="no_display" id="step2">
                    <div class="card-block px-lg-7 px-4 pb-6">
                        <div class="lead text-muted mb-4 mr-3">
                        ...
                        <div class="mb-3">
                            ...
                            <button class="btn btn-primary" type="button" onClick="restore.send(); return false" id="send2">Да, это нужная страница</button>
                        </div>
                    </div>
                </div>
                <div class="no_display"  id="step3">
                    <div class="card-block px-lg-7 px-4 pb-6">
                        <div class="lead text-muted mb-4 mr-3">
                            На ваш электронный ящик были высланы инструкции по восстановлению пароля.
                        </div>
                    </div>
                </div>
            </div>
