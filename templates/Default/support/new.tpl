		...
		<div class="col-4">
			<nav class="navbar navbar-light">
				<div class="container-fluid">
					<a href="/support/" onClick="Page.Go(this.href); return false;" class="navbar-brand">[group=4]Вопросы от пользователей[/group][not-group=4]Мои вопросы[/not-group]</a>
				</div>
			</nav>[not-group=4]
			<nav class="navbar navbar-light">
				<div class="container-fluid">
					<a href="/support/new/" onClick="Page.Go(this.href); return false;" class="navbar-brand mb-0 h1">Задать вопрос</a>
				</div>
			</nav>[/not-group]
		</div>
		<div class="col-8">
			<div id="data">
				...
				[/not-group]
				[group=4]<div class="info_center">Вы должны всё знать.</div>[/group]
			</div>
		</div>
	</div>
</div>
