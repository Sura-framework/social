...
{
    //Лимиты на день
    protected static array $max_int = array(
        1 => 40,#максимум заявок в друзья
        2 => 40,#максимум сообщений не друзьям
        3 => 100,#максимум записей на стену /wall
        4 => 100,#максимум одинаковых текстовых данных /identical
        5 => 300,#максимум комментариев к записям на стенах людей и сообществ /comments
        6 => 2,#максимум сообществ за день
        7 => 1,
        8 => 1,
        9 => 1,//bugs
        10 => 1,
