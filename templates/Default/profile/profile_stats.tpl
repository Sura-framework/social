...
<div class="search_form_tab" style="margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
  ...
  <div class="buttonsprofileSec"><a href="/my_stats/"><div><b>Статистика страницы</b></div></a></div>
  <div class="fl_r">
   ...
   <div class="button_div fl_l"><button onClick="location.href = '/my_stats/?m='+$('#month').val()+'&y='+$('#year').val()">Просмотреть</button></div>
  </div>
 </div>
</div>
<div class="clear"></div>
