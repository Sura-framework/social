...
<div class="buttonsprofile albumsbuttonsprofile" style="height:10px;">
 ...
 <div class="{activetab-own}"><a href="/wall/{uid}/own/" onClick="Page.Go(this.href); return false;"><div>Записи {name}</div></a></div>
 [record-tab]<div class="{activetab-record}"><a href="/wall/{uid}/{rec-id}/" onClick="Page.Go(this.href); return false;"><div>Запись на стене</div></a></div>[/record-tab]
