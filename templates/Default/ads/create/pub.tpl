...
<ul class="radio-group" onclick="ads.changeform('1');" style="width:500px">
	<li><input type="radio" checked name="format" id="format1"><label for="format1"><span><span></span></span>Изображение и текст</label></li>
</ul>
...
<div class="mgclr"></div><div class="texta"></div>
<ul class="radio-group" onclick="ads.changeform('3');" style="width:500px"><li><input type="radio" name="format" id="format3"><label for="format3"><span><span></span></span>Продвижение сообществ</label></li></ul>
<div class="mgclr"></div>
...
<div class="texta"></div><div class="button_div fl_l"><button onClick="ads.create('pub'); return false">Создать объявление</button></div><div class="mgclr"></div>