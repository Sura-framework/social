...
<ul class="radio-group" onclick="ads.changeform('1');" style="width:500px">
	<li><input type="radio" checked name="format" id="format1">
		<label for="format1"><span><span></span></span>Изображение и текст</label></li>
</ul>
<div class="mgclr"></div><div class="texta"></div>
<ul class="radio-group" onclick="ads.changeform('2');" style="width:500px">
	<li><input type="radio" name="format" id="format2"><label for="format2"><span><span></span></span>Большое изображение</label></li>
</ul>
<div class="mgclr"></div><div class="texta"></div>
<ul class="radio-group" onclick="ads.changeform('4');" style="width:500px">
	<li><input type="radio" name="format" id="format4"><label for="format4"><span><span></span></span>Квадратное изображение</label></li>
</ul>
<div class="mgclr"></div>
...
<div class="texta"></div><div class="button_div fl_l"><button onClick="ads.create('app'); return false">Создать объявление</button></div><div class="mgclr"></div>