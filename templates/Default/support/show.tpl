<div class="search_form_tab" style="background:#fff;margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile" style="height:22px">
  ...
  <div class="activetab"><a href="/support/show/{qid}/" onClick="Page.Go(this.href); return false;"><div><b>Просмотр вопроса</b></div></a></div>
 </div>
</div>
<div class="note_full_title">
 <span><a href="/support/show/{qid}/" onClick="Page.Go(this.href); return false">{title}</a></span><br />
