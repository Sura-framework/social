...
<div class="note_full_title" style="margin-top:8px">
 <span id="titleTeck"><a href="/forum/{id}/view/{fid}/" onClick="Page.Go(this.href); return false" id="editTitleSaved">{title}</a><br /></span>
...
<textarea 
	...
	id="fast_text_1" 
	style="width:682px;height:37px;color:#c1cad0;margin-left:3px;color:#000"
