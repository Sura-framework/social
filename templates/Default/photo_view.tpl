...
<div class="photo_close" onClick="Photo.Close('{close-link}'); return false;"></div>
 <div class="photo_bg">
  ...
  [all]<a href="/photo/{uid}/{prev-id}/{section}/" onClick="Photo.Show(this.href); return false"><div class="photo_prev_but"></div></a>
  <a href="/photo/{uid}/{next-id}/{section}/" onClick="Photo.Show(this.href); return false"><div class="photo_next_but"></div></a>[/all]
  ...
  <div class="ratingbg">
    [not-owner]<div class="ratpos {rate-check}" id="ratpos{id}">
     <div onClick="Photo.addrating(1, {id}, this.style)" class="rating" style="background:url('/images/rating3.png')">1</div>
     ...
     <div onClick="Photo.addrating(6, {id})" class="rating" style="background:url('/images/rating2.png')">5+</div>
    </div>
    <img src="/images/ajax-loader.gif" id="rateload{id}" class="no_display" style="margin-left:255px;margin-top:12px" />
  ...
  <div class="photo_rightcol">
   ...
   <div class="menuleft" style="width:209px;">
    <a href="/" onClick="Distinguish.Start({id}); return false"><img class="icon ic_mark" src="/images/spacer.gif" alt="" /><div>Отметить человека</div></a>
	 [owner]<a href="/" onClick="photoeditor.start('{photo}', '{id}', '{height}'); return false"><img class="icon edit_ic" src="/images/spacer.gif" alt="" /><div>Корректировать</div></a>
   <a href="/" onClick="crop.start({id}); return false"><img class="icon ic_cover" src="/images/spacer.gif" alt="" /><div>Поместить на мою страницу</div></a>
   <a href="/" onClick="Photo.EditBox({id}, 0); return false"><img class="icon editphoto_ic" src="/images/spacer.gif" alt="" /><div>Редактировать фотографию</div></a>
   <a href="/" onClick="Photo.MsgDelete({id}, {aid}, 1); return false"><img class="icon del_photo_ic" src="/images/spacer.gif" alt="" /><div>Удалить фотографию</div></a>[/owner]
   <a onClick="Report.Box('photo', '{id}')"><img class="icon compla_ic" src="/images/spacer.gif" alt="" /><div>Пожаловаться на фотаграфию</div></a>
   [owner]<div class="photos_gradus_pos">
	...
	<div class="fl_l" style="margin-left:5px"><img src="/images/loading_mini.gif" id="loading_gradus{id}" class="no_display" /></div>
   </div>[/owner]
   </div>
  </div>
 </div>
