...
$(document).ready(function(){
	[admin]ajaxUpload = new AjaxUpload('upload_cover', {
		action: '/groups/upload_cover&id={id}',
		name: 'uploadfile',
...
[admin]<div class="cover_loading no_display"><img src="/images/progress_gray.gif" /></div>
...
[not-admin][cover]<div class="cover_all_user"><img src="{cover}" width="794" id="cover_img" {cover-param-5} /></div>[/cover][/not-admin]
...
<div class="ava fl_r" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
 ...
 <div class="menuleft" style="margin-top:5px">
  ...
  <a href="/stats/{id}/"><div>Статистика страницы</div></a>
  [admin]<a href="/" onClick="groups.loadphoto('{id}'); return false"><img class="icon editphoto_ic" src="/images/spacer.gif" alt="" /><div>Изменить фотографию</div></a>
  <span id="del_pho_but" class="{display-ava}"><a href="/" onClick="groups.delphoto('{id}'); return false;"><img class="icon del_photo_ic" src="/images/spacer.gif" alt="" /><div>Удалить фотографию</div></a></span>
  <a href="/" onClick="groups.editform(); return false"><img class="icon ic_edit" src="/images/spacer.gif" alt="" /><div>Управление страницей</div></a>[/admin]
 </div>
 ...
 <div style="margin-top:7px">
  ...
  [videos]<div class="public_vlock cursor_pointer" onClick="Page.Go('/public/videos/{id}/'); return false">Видеозаписи</div>
 <div class="public_bg">
...
<div class="profiewr">
 ...
 <a href="/forum{id}/new" onClick="Page.Go(this.href); return false" class="fl_r {no}" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px;color:#ddd">Новая тема</div></a>
