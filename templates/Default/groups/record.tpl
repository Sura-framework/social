[record]<div class="wallrecord wall_upage public_wall" id="wall_record_{rec-id}" style="padding-bottom:5px;margin-top:5px">
 ...
 [owner]<div class="wall_delete" onMouseOver="myhtml.title('{rec-id}', 'Удалить запись', 'wall_del_')" onClick="groups.wall_delet('{rec-id}'); return false" id="wall_del_{rec-id}"></div>
 <div class="wall_fasten" onMouseOver="myhtml.title('{rec-id}', '{fasten-text}', 'wall_fasten_')" onClick="groups.{function-fasten}('{rec-id}'); return false" id="wall_fasten_{rec-id}" {styles-fasten}></div>[/owner]
 ...
 <div class="size10 infowalltext_f clear">
  <div class="fl_l"><a href="/wallgroups/{public-id}/{rec-id}/" onClick="Page.Go(this.href); return false" class="online">{date}</a> [privacy-comment][comments-link]<span id="fast_comm_link_{rec-id}" class="fast_comm_link">&nbsp;|&nbsp; <a href="/" id="fast_link_{rec-id}" onClick="wall.open_fast_form('{rec-id}'); wall.fast_open_textarea('{rec-id}'); return false">Комментировать</a></span>[/comments-link][/privacy-comment]</div>
