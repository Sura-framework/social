 ...
 <div class="container video_show_bg">
  ...
  <div class="video_show_panel" id="video_del_info">
   ...
   <div class="photo_rightcol">
	...
	[public]<div class="menuleft" style="width:220px;">
     [owner]<a href="/" onClick="videos.editbox({vid}); return false"><img class="icon editphoto_ic" src="/images/spacer.gif" alt="" /><div>Редактировать видеозапись</div></a> 
	 <a href="/" onClick="videos.delet({vid}, 1); return false"><img class="icon del_photo_ic" src="/images/spacer.gif" alt="" /><div>Удалить видеозапись</div></a>[/owner]
	 <a onClick="Report.Box('video', '{vid}')"><img class="icon compla_ic" src="/images/spacer.gif" alt="" /><div>Пожаловаться на видеозапись</div></a>
    </div>[/public]
   </div>
  <div class="clear"></div>
  </div>
