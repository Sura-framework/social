            ...
            <div class="d-flex flex-column align-content-between justify-content-between ">
                <div class="d-flex flex-column p-3" >
                    ...
                    <a href="{{ $gifts_link }}" onclick="Page.Go(this.href); return false" class="left_row">
                        ...
                        <span class="left_label inl_bl ">Баланс <span id="new_ubm">{{ $gifts_link }}</span></span>
                    </a>
                </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <a href="/{{ $row['link'] }}{{ $row['author_id'] }}" class="avatar" onmouseover="wall.showTag({{ $row['author_id'] }}, {{ $row['rec_id'] }}, 1)" onmouseout="wall.hideTag({{ $row['author_id'] }}, {{ $row['rec_id'] }}, 1)">
                                            <img src="{{ $row['ava'] }}" alt="{{ $row['author'] }}" class="avatar-img rounded-circle">
                                        </a>
                                    </div>
                                    <div class="col ml-n2">
                                        <h4 class="mb-1"  onmouseover="wall.showTag({{ $row['author_id'] }}, {{ $row['rec_id'] }}, 1)" onmouseout="wall.hideTag({{ $row['author_id'] }}, {{ $row['rec_id'] }}, 1)">
                                            {{ $row['author'] }}
                                        </h4>
